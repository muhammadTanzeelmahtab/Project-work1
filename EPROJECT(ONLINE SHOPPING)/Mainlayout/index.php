...
<?php while($data = mysqli_fetch_assoc($res)){ echo '<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">';?>

   
<div class="single-new-pro mb-30 text-center">
<div class="product-img">
<img src="<?=@$data['Cimg'] ?>"  alt="" height = 400px;>
</div>
<div class="product-caption">
<h3><a href="product_details.html"><?=@$data['Cname'] ?></a></h3>
</div>
</div>
